...
int main()
{
  ...
  cout << setw(10) << name << setfill('#') << setw(7) 
       << gpa << setw(8) << scholarship << endl;
  ...
  cout << setfill('.');
  cout << left << setw(10) << name << setw(13) << right << scholarship << endl;
  cout << left << setw(10) << name << setw(13) << right << gpa << endl;
